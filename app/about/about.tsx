...
export default function Main_Page() {
  return (
    <main className="min-h-screen flex justify-center items-center bg-[#1f1a1a] my-10 overflow-hidden border-y-8 border-[#695b4e]">
      <div className="flex flex-col-reverse md:flex-row lg:flex-row justify-center items-center w-full max-w-[1200px] gap-16 p-6">

        {/* About Us Section */}
        <div className="flex flex-col text-[#D6BE8D] p-4 bg-[#292323] rounded-md mt-10 md:w-[500px] lg:w-[700px]" data-aos="zoom-in-down">
          <h1 className="text-center text-4xl font-semibold animate-shine py-5">ABOUT ME</h1>
          <h2 className="text-center text-2xl lg:text-3xl font-bold font-serif text-[#D6BE8D] p-5">I&#39;m Muhammad Hammad </h2>
