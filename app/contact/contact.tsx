...
const ContactPage = () => {
  ...
  return (
    <div className="contact-page flex flex-col items-center relative h-screen justify-center">
      <Image src="/portfolio2-my-img.jpg" height={180} width={180} alt="My Image" className="img w-[180px] h-[180px] lg:w-[250px] lg:h-[250px] rounded-full shadow-lg shadow-[#916e80]" />
      ...
      <div className="icons-container absolute inset-0 flex items-center justify-center">
        {socialIcons.map((icon, index) => (
          <a
            ...
            className="icon absolute text-[#cc91af] hover:text-[#c2588d] "
            style={{
